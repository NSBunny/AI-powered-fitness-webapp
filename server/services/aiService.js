...
const generateMealPlan = async (userProfile, preferences) => {
    try {
        ...
        Format the response as a JSON object with days of the week as keys and meals (breakfast, lunch, dinner, snacks) as values. Do not include markdown formatting like \`\`\`json. Return only the raw JSON string.`;
